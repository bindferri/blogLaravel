                    ...
                    <section class="mt-10 space-y-6">
                        ...
                        <form action="/posts/{{$post->slug}}/comments" method="post" class="border border-gray-200 p-6 rounded-xl">
                            ...
                            <header class="flex items-center">
                                <img src="https://robohash.org/honey?set=set1" alt="" class="rounded-full" width="60" height="60">
                                <h2 class="ml-4">Want to participate?</h2>
                            </header>
                            <div class="mt-6">
                                <textarea name="body" class="w-full text-sm focus:outline-none focus:ring" id="" rows="5" placeholder="Say something..."></textarea>
                            </div>
                            @error('body')
